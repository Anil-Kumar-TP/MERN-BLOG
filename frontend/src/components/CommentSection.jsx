        ...
        <div className='max-w-2xl mx-auto p-3 w-full'>
            {currentUser ? (
                <div className='flex items-center gap-1 my-5 text-gray-500 text-sm'>
                    <p>Signed in as : </p>
                    <img src={currentUser.profilePicture} alt="commentProfile" className='h-5 w-5 object-cover rounded-full' />
            ...
            <Modal show={showModal} onClose={() => setShowModal(false)} popup size='4xl'>
                ...
                <Modal.Body>
                    <div className='text-center'>
                        ...
                        <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Are u sure u want to delete this comment?</h3>
