            ...
            {userPosts && userPosts.map((post) => (
              <Table.Body className='divide-y' key={post._id}>
                <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800'>
                  ...
                  <Table.Cell>
                    <Link className='text-yellow-500 font-medium hover:underline cursor-pointer' to={`/update-post/${post._id}`}>
                      <span>Edit</span>
                    </Link>
                  </Table.Cell>
                </Table.Row>
      ...
      <Modal show={showModal} onClose={() => setShowModal(false)} popup size='4xl'>
        ...
        <Modal.Body>
          <div className='text-center'>
            ...
            <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Are u sure u want to delete this post?</h3>
